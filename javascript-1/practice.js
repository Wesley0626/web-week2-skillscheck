...
// Code Here
let doubled = myNumbers.map(number => number*2)
...
// Code Here
let myNumbersIndex =[]
myNumbers.forEach((a, b, c) => myNumbersIndex.push(b)) 
...
notGeorge.map(name => forTheLoveOfGeorge.push(name='George'))
...
// Code Here
let enemies = people.filter(obj => obj.friend === false)
...
// Code Here
let totallyAwesome =  people.reduce((sum, person)=> {return sum+person.awesomeLevel}, 0)